...
export default function AppNavigation() {
  return (
    ...
    >
      ...
      />
      <Tab.Screen
        name={routes.TOPPROF_SCREEN}
        component={TopprofScreen}
        options={{ title: "topprof" }}
      />
      <Tab.Screen
        name={routes.PROFILEWATCH_SCREEN}
        component={ProfilewatchScreen}
        options={{ title: "profilewatch" }}
      />
      <Tab.Screen
